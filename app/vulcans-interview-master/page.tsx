...
export default function InterviewPage() {
  ...
  return (
    <main className="pt-20 pb-16 bg-background text-foreground">
      ...
      <section
        id="more-info"
        className="container mx-auto px-4 md:px-6 lg:px-16 space-y-16 py-12"
      >
        {/* Why Section */}
        ...
        <div className="space-y-6">
          ...
          <Card className="border border-border/60 shadow-md">
            <CardContent className="p-8 md:p-10">
              <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
                Think of it as your personal interview coach, available 24×7. It
                asks real questions, listens to your responses, and even throws
                follow-up questions just like a human panel would. The
                difference? It also tells you how you performed — what went
                well, what could be better, and exactly how to improve next
                time.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8 md:p-10">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-vulcan-accent-blue mt-1 flex-shrink-0" />
                  <p className="text-base md:text-lg text-foreground/80">
                    Job seekers looking to improve their confidence and
                    communication
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-vulcan-accent-blue mt-1 flex-shrink-0" />
                  <p className="text-base md:text-lg text-foreground/80">
                    Professionals aiming for a career switch or promotion
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-5 w-5 text-vulcan-accent-blue mt-1 flex-shrink-0" />
                  <p className="text-base md:text-lg text-foreground/80">
                    Colleges & Institutions that want to evaluate candidates
                    through fair, smart, and efficient AI interviews
                  </p>
                </div>
              </div>
            </CardContent>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground/80 leading-relaxed">
                      You won't be answering robotic questions. Vulcan Interview
                      Master holds dynamic, natural conversations — adjusting
                      based on what you say, just like a real interviewer.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground/80 mb-3 leading-relaxed">
                      After every session, you get a detailed report that
                      covers:
                    </p>
                    <ul className="space-y-2 text-sm text-foreground/70">
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-vulcan-accent-blue mt-0.5 flex-shrink-0" />
                        <span>
                          How relevant and structured your answers were
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle2 className="h-4 w-4 text-vulcan-accent-blue mt-0.5 flex-shrink-0" />
                    ...
                    <p className="text-foreground/80 mt-3 leading-relaxed italic">
                      It's not just numbers — it's feedback you can actually
                      use.
                    </p>
                  </div>
                </div>
              ...
              <CardContent className="p-6 md:p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-foreground/80 leading-relaxed">
                      Upload your resume and get an ATS (Applicant Tracking
                      System) score with practical tips to make it stand out in
        ...
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <Card
                key={idx}
                className="border border-border/60 shadow-sm bg-muted/20"
              >
          ...
          <Card className="border border-border/60 shadow-lg bg-gradient-to-br from-vulcan-accent-blue/5 via-background to-muted/10">
            <CardContent className="p-8 md:p-12">
              ...
              <p className="text-base md:text-lg text-foreground/70 mt-6 italic">
                Don't wait for the next interview call to start preparing. Take
                your first AI interview now — and meet the best version of
                yourself.
              </p>
            </CardContent>
          </Card>
