...
export default function InterviewPage() {
  ...
  return (
    <div className="h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth">
      {/* Hero Section */}
      <section className="relative w-full pt-20 pb-16 md:pt-24 md:pb-24 lg:pt-32 lg:pb-32 bg-gradient-to-br from-gray-50 via-white to-blue-50 min-h-screen flex items-center snap-start">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
