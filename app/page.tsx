          ...
          <div className="relative container mx-auto px-4 md:px-6 lg:px-8 w-full py-4 md:py-6">
            <div className="max-w-7xl mx-auto w-full">
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12 w-full">
                ...
                <ScrollReveal direction="right" className="w-full lg:w-1/2 space-y-4 md:space-y-6 z-10">
                  {/* Badge */}
                  ...
                  <p className="mt-3 md:mt-4 text-base md:text-lg text-foreground/80 text-pretty max-w-xl">
                    ...
                    and real-time feedback. Vulcan Interview Master is your comprehensive platform to 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                      <div className="flex items-start gap-3 group">
                        ...
                        <div>
                          ...
                          <span className="text-xs md:text-sm text-foreground/80">
                            Tailored sessions for your industry and role
                          </span>
                        </div>
                      </div>
                      <div className="flex items-start gap-3 group">
                      ...
                      <div className="flex items-start gap-3 group">
                        ...
                        <div>
                          ...
                          <span className="text-xs md:text-sm text-foreground/80">
                            Wide range of interview preparation courses
                          </span>
                        </div>
                      </div>
                      <div className="flex items-start gap-3 group">
                ...
                <ScrollReveal direction="left" delay={0.2} className="w-full lg:w-1/2 relative z-10 flex items-center justify-center lg:justify-end">
                  <div className="relative w-full max-w-md lg:max-w-lg mx-auto lg:mx-0">
                    ...
                    <div className="absolute bottom-4 left-4 bg-background/90 backdrop-blur-md rounded-2xl p-4 shadow-lg border border-border/50 z-20">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-foreground/60">Success Rate</p>
