    ...
    <section className="w-full py-20 md:py-32 lg:py-40 bg-background dark:bg-background">
      <div className="flex flex-col gap-24 px-4 sm:px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-24">
          ...
          <div className="w-full flex-1 text-left">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground/80 mb-8 leading-relaxed">
              Our mission is to empower individuals with transformative testing
              and training solutions that bridge the gap between academic theory
              and practical application, fostering career skills and unmatched
              confidence.
            </p>
          </div>

          {/* Right side - image */}
          <div className="w-full flex-1 flex justify-center lg:justify-end mt-6 lg:mt-0">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-24">
          {/* Left side - image */}
          <div className="w-full flex-1 flex justify-center lg:justify-start mb-6 lg:mb-0">
            <div className="relative w-full h-96">
              <Image
                src="/vision.jpg"
                alt="Our Vision"
          ...
          <div className="w-full flex-1 text-left">
            ...
            <p className="text-base sm:text-lg md:text-xl text-foreground/80 mb-8 leading-relaxed">
              ...
              assessment, driving excellence in communication, adaptability, and
