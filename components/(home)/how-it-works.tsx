  ...
  const steps = [
    {
      ...
      content: "Signup for an account or log in to your existing account.",
    ...
    },
    {
      ...
      content:
        "Select from a wide variety of skill-based courses designed to match your goals.",
      src: "/learning1.jpg",
      category: "",
    },
    {
      ...
      content:
        "Engage with interactive lessons, real-world projects, and instant feedback.",
      src: "/teacher.jpg",
      category: "",
    },
    {
