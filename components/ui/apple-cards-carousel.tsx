        ...
        {variant === "apple" && (
          <>
            ...
            <div className="relative z-40 p-8">
              <motion.p layoutId={layout ? `category-${card.category}` : undefined} className="text-left font-sans text-sm font-medium text-white md:text-base mb-1">
                {card.category}
              </motion.p>
              <motion.p layoutId={layout ? `title-${card.title}` : undefined} className="text-3xl md:text-4xl font-light tracking-tight text-white mb-4 text-left leading-tight">
                {card.title}
              </motion.p>
              <motion.p className="text-sm md:text-base text-white/90 text-left line-clamp-3">
                {card.content}
              </motion.p>
            </div>
